...
export default function BuyRegalia() {
  ...
  const generateCSV = () => {
    ...
    a.href = url;
    a.download = `Buy_Orders_${new Date().toISOString().split("T")[0]}.csv`;
    a.click();
          ...
          <div className="search-filter-container">
            <div className="search-filter-wrapper">
              <div className="filter-wrapper search-wrapper">
                ...
                <input
                  type="text"
                  placeholder="Search by reference number, customer name, or student ID, email..."
                  value={searchTerm}
              ...
              <div className="modal-content">
                <div className="modal-inner">
                  ...
                  <div className="modal-footer">
                    <button onClick={closeOrderModal} className="close-button">
                      Close
                    </button>
                  </div>
                </div>
